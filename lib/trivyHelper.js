...
function getVulnerabilityIdsBySeverity(trivyStatus, removeDuplicates) {
    const severities = [SEVERITY_CRITICAL, SEVERITY_HIGH, SEVERITY_MEDIUM, SEVERITY_LOW, SEVERITY_UNKNOWN];
    ...
    console.log("vulnerabilityIdsBySeverity:\n", vulnerabilityIdsBySeverity);
